...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .grade { flex:1; display:grid; grid-template-columns: 1fr 1fr; grid-auto-rows: minmax(96px, auto); gap:14px 18px; align-content:start; }
  .produto { display:flex; gap:12px; border:1px solid #e6ecf0; border-radius:10px; padding:10px; align-items:center; }
  .produto-img { width:88px; height:88px; flex:0 0 88px; display:flex; align-items:center; justify-content:center; background:#f8fafb; border-radius:8px; overflow:hidden; }
  .produto-img img { max-width:100%; max-height:100%; object-fit:contain; }
  .produto-info { flex:1; min-width:0; }
  .produto-marca { color:#00a859; font-weight:800; font-size:9px; text-transform:uppercase; letter-spacing:.5px; }
  .produto-nome { font-weight:700; font-size:11.5px; line-height:1.25; margin:3px 0; color:#0f2a3d; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; }
  .produto-cod { font-size:9.5px; color:#6b7c85; }
  .produto-preco { font-weight:800; font-size:13px; color:#00334d; margin-top:4px; }
